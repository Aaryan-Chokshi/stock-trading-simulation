...
function socketHandler(msg){
    ...
    socket.onmessage = function(event) {
        ...
        document.getElementById('market-status').innerHTML =  data['marketStatus'];
        document.getElementById('ltp').innerHTML =  data['last'];
        document.getElementById('percent-change').innerHTML = data['percentChange'] + "%";
        document.getElementById('variation').innerHTML =  data['variation'];
    }
...
function holdingsHandler(event){
    fetch(`http://localhost:8401/api/holding_details/${dbid}`,{
        method: "GET",
        headers: {
        "Content-Type": "application/json",
        },
